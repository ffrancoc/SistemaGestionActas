...
function mostrarModalContrayente(){
  ...
  const contrayenteLabel = getItemById("contrayente2MatrimonioLabel");
  const modalContrayenteTitle = getItemById("modalContrayenteTitle");
...
window.mostrarModalContrayente = mostrarModalContrayente;


function seleccionarContrayente(){
  const contrayente = document.querySelector('input[name="contrayente"]:checked');
  const contrayente2Matrimonio = getItemById("contrayente2Matrimonio");
  const idContrayente2Matrimonio = getItemById("idContrayente2Matrimonio");

  if (contrayente !== null){
    const url = detalleRegistroURL.replace("/0/", "/" + contrayente.value + "/");
    ...
    setValueContent("idContrayente2Matrimonio", "");
    setValueContent("contrayente2Matrimonio", "");
  }
}

window.seleccionarContrayente = seleccionarContrayente;
