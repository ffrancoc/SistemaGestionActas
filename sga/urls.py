...
urlpatterns = [
    ...
    path('sga/registro/<int:registro_id>/detalle', views.detalle_registro, name='detalle_registro'),
    path('sga/registro/<int:registro_id>/eliminar', views.eliminar_registro, name='eliminar_registro'),
    path('sga/registro/<int:registro_id>/detalles/actas', views.detalle_actas, name='detalle_actas'),
    ...
    path('sga/bautismo/<int:bautismo_id>/eliminar', views.eliminar_bautismo, name='eliminar_bautismo'),
]
